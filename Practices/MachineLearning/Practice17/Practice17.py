...
if __name__ == '__main__':
    ...
    confusion_matrix.field_names = ['  ','Actual 1','Actual 0']
    confusion_matrix.add_row( ['Predicted 1', true_positive , false_positive ] )
    confusion_matrix.add_row( ['Predicted 0', false_negative , true_negative ] )
    print('''\n\n
    \t**************************************************
                    Matriz de confusion 
    \t**************************************************''')
    ...
    metric = PrettyTable()
    metric.field_names = [' Precision ','Recall','F1']
    metric.add_row( [precision,recall,F] )
