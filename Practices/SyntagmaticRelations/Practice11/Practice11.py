...
|           Syntagmatic Relations of the words, Conditional             |
|                Entropy and Estimation of probabilities                |
|                                                                       |
+-----------------------------------------------------------------------+
'''
...
def getEntropy( table ):
    x1 = table[3] * math.log2( table[3] / (table[0]*table[2]) ) + table[6] * math.log2( table[6] / (table[1]*table[2] ))
    x2 = table[4] * math.log2( table[4] / (table[1]*table[2]) ) + table[7] * math.log2( table[7] / (table[1]*table[5] ))
    H = ( x1 + x2 )
